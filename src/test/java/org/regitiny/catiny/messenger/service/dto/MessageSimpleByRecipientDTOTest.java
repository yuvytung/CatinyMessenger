...
public class MessageSimpleByRecipientDTOTest {
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        messageSimpleByRecipientDTO1.setId(UUID.randomUUID());
        ...
        messageSimpleByRecipientDTO2.setId(messageSimpleByRecipientDTO1.getId());
        assertThat(messageSimpleByRecipientDTO1).isEqualTo(messageSimpleByRecipientDTO2);
        messageSimpleByRecipientDTO2.setId(UUID.randomUUID());
        assertThat(messageSimpleByRecipientDTO1).isNotEqualTo(messageSimpleByRecipientDTO2);
        messageSimpleByRecipientDTO1.setId(null);
        assertThat(messageSimpleByRecipientDTO1).isNotEqualTo(messageSimpleByRecipientDTO2);
    }
}
