...
public class MessageSimpleByRecipientResource {
     ...
     *
     * @param id the id of the messageSimpleByRecipientDTO to delete.
     * @return the {@link ResponseEntity} with status {@code 204 (NO_CONTENT)}.
     */
    @DeleteMapping("/message-simple-by-recipients/{id}")
    public ResponseEntity<Void> deleteMessageSimpleByRecipient(@PathVariable UUID id) {
        log.debug("REST request to delete MessageSimpleByRecipient : {}", id);
        messageSimpleByRecipientService.delete(id);
